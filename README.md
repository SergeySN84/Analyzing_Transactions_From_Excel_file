...
- Реализовать отчета на странице "События".
- Создать отчет трат по категориям
...
Проект на стадии разработки, в данном коде реализованы функция "Сервиса", страницы "События" и 
отчет трат по категориям для будущего
...
Запустить их можно командой pytest tests/
#Проект приложения для анализа транзакций, которые находятся в Excel-файле.
